...
/*   Updated: 2025/03/22 03:01:11 by bchiki           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	setup_mlx(t_game *game)
{
	...
	load_textures(game);
	if (!game->tex.wall || !game->tex.floor || !game->tex.player_looking_right
		|| !game->tex.player_looking_left || !game->tex.player_looking_back
		|| !game->tex.player_looking_direct || !game->tex.collectible
		|| !game->tex.exit || !game->tex.exit_open || !game->tex.in_top_of_exit)
	{
