...
/*   Updated: 2025/03/22 19:53:28 by bchiki           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    if (game->map[new_pos] != '1')
    {
        ...
        else
        {
            ...
            if (game->map[new_pos] == 'C')
                game->collectibles--;
            if (game->map[old_pos] != 'E') // Don’t overwrite 'E' when leaving it
                game->map[old_pos] = '0';
            if (game->map[new_pos] != 'E') // Don’t overwrite 'E' when moving onto it
                game->map[new_pos] = 'P';
            game->player_x = new_x;
            game->player_y = new_y;
        }
