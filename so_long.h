...
/*   Updated: 2025/03/22 02:43:02 by bchiki           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    flood_fill(t_game *game, int x, int y, int *collectibles_reached, int *exit_reached, char **visited);
...
int     handle_map_element(t_game *game, int x, int y, int *p_count, int *e_count, int *c_count);
...
int validate_reachability(int collectibles_reached, int total_collectibles, int exit_reached);
